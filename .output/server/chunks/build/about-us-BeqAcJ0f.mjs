...
import { _ as _imports_0 } from './trophy-DnAt3UlU.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.img != null && __props.img != "") {
        _push(`<img class="w-[50px] h-[50px]" style="${ssrRenderStyle({ "border-radius": "50%" })}"${ssrRenderAttr("src", "https://admin.ecatalog.cloud/" + __props.img)} alt="trophy">`);
      } else {
        _push(`<img${ssrRenderAttr("src", _imports_0)} alt="trophy">`);
      }
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div style="${ssrRenderStyle({ "padding-top": "16px" })}">`);
      ...
      _push(`</div><div class="mt-4 flex flex-col justify-start mx-4">`);
      if (unref(about)[0] && unref(about)[0].content_page == "ABOUT") {
        _push(`<div class="paragraph mt-2">${ssrInterpolate(unref(about)[0].content_text)}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(about)[0] && unref(about)[0].content_page == "ABOUT") {
      ...
      _push(`<img${ssrRenderAttr("src", "https://admin.ecatalog.cloud/" + unref(dataAbout).merchant_logo)} alt="trophy" class="mt-6 w-[100%]"></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/[name]/about-us.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=about-us-BeqAcJ0f.mjs.map
