import { useSSRContext, resolveComponent, mergeProps, unref, withCtx, createVNode, ref } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "top-0 bg-white w-full md:w-[100%] flex flex-col my_menu",
        style: { "position": "sticky", "box-shadow": "0px 1px 3px rgba(0, 0, 0, 0.15),\r\n        0px -1px 3px rgba(0, 0, 0, 0.15)", "z-index": "100" }
      }, _attrs))} data-v-04a997f6><div class="flex" data-v-04a997f6>`);
      _push(ssrRenderComponent(_component_router_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="${ssrRenderClass([{ "active-menu": _ctx.activeTab === "product" }, "menu transition-all duration-300"])}" data-v-04a997f6${_scopeId}> Product </p>`);
          } else {
            return [
              createVNode("p", {
                class: ["menu transition-all duration-300", { "active-menu": _ctx.activeTab === "product" }],
                onClick: ($event) => _ctx.setActiveTab("product")
              }, " Product ", 10, ["onClick"])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_router_link, {
        to: "/" + unref(name) + "/e-catalog/",
        style: { "width": "33%", "text-align": "center" }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="${ssrRenderClass([{ "active-menu": _ctx.activeTab === "ecatalog" }, "menu transition-all duration-300"])}" data-v-04a997f6${_scopeId}> E-Catalog </p>`);
          } else {
            return [
              createVNode("p", {
                class: ["menu transition-all duration-300", { "active-menu": _ctx.activeTab === "ecatalog" }],
                onClick: ($event) => _ctx.setActiveTab("ecatalog")
      ...
      _push(ssrRenderComponent(_component_router_link, {
        to: "/" + unref(name) + "/contact-us/",
        style: { "width": "33%", "text-align": "center" }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="${ssrRenderClass([{ "active-menu": _ctx.activeTab === "contact" }, "menu transition-all duration-300"])}" style="${ssrRenderStyle({ "margin-right": "0" })}" data-v-04a997f6${_scopeId}> Contact </p>`);
          } else {
            return [
              createVNode("p", {
                class: ["menu transition-all duration-300", { "active-menu": _ctx.activeTab === "contact" }],
                onClick: ($event) => _ctx.setActiveTab("contact"),
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-04a997f6"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-1c493d17><div class="flex items-start justify-around" data-v-1c493d17><a${ssrRenderAttr("href", unref(phone))} class="flex items-center gap-2 mt-3" data-v-1c493d17><img${ssrRenderAttr("src", _imports_0)} alt="trophy" class="w-7" data-v-1c493d17><p class="menu-3" style="${ssrRenderStyle({ "font-size": "12px !important" })}" data-v-1c493d17>Phone</p></a><a${ssrRenderAttr("href", unref(email))} class="flex items-center gap-2 mt-3" data-v-1c493d17><img${ssrRenderAttr("src", _imports_1)} alt="trophy" class="w-7" data-v-1c493d17><p class="menu-3" style="${ssrRenderStyle({ "font-size": "12px !important" })}" data-v-1c493d17>Email</p></a><a${ssrRenderAttr("href", unref(whatsapp))} class="flex items-center gap-2 mt-3" data-v-1c493d17><img${ssrRenderAttr("src", _imports_2)} alt="trophy" class="w-7" data-v-1c493d17><p class="menu-3" style="${ssrRenderStyle({ "font-size": "12px !important" })}" data-v-1c493d17>Whatsapp</p></a></div><div class="w-full h-[5px] bg-[#FF9212] mt-[14px]" data-v-1c493d17></div></div>`);
    };
  }
};
...
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1c493d17"]]);

export { Footer as F, Menu as M };
//# sourceMappingURL=Footer-CJzcZJHs.mjs.map
